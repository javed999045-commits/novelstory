...
export default function WelcomePage() {
  ...
  const handleRoleSelection = (role: 'listener' | 'creator') => {
    localStorage.setItem('loginRedirectRole', role);
    ...
    <main className="flex items-center justify-center min-h-screen bg-background p-4">
      <Card className="w-full max-w-sm border-border bg-card text-card-foreground">
        ...
        <CardContent className="grid gap-4">
          <Button size="lg" className="h-auto py-4" onClick={() => handleRoleSelection('listener')}>
           ...
           <Button size="lg" variant="secondary" className="h-auto py-4" onClick={() => handleRoleSelection('creator')}>
            <div className="flex flex-col items-center">
